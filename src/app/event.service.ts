    ...
    this.eventArray = [
      {
        ...
        type: 'external',
        image: 'assets/event-pictures/external-events/concert.jpg',
      },
      {
        id: id2,
        ...
        type: 'external',
        image: 'assets/event-pictures/external-events/felix.jpg',
      },
      {
        id: id3,
        ...
        description: 'Another journey chamber way yet females man. Way extensive and dejection get delivered deficient sincerity gentleman age. Too end instrument possession contrasted motionless. Calling offence six joy feeling. Coming merits and was talent enough far. Sir joy northward sportsmen education. Discovery incommode earnestly no he commanded if. Put still any about manor heard.',
        type: 'external',
        image: 'assets/event-pictures/external-events/schule.jpg',
      },
      {
        id: id4,
        title: 'Vienna Orchestra',
        start: start4,
        end: null,
        location: 'Das Dock',
        description: 'Another journey chamber way yet females man. Way extensive and dejection get delivered deficient sincerity gentleman age. Too end instrument possession contrasted motionless. Calling offence six joy feeling. Coming merits and was talent enough far. Sir joy northward sportsmen education. Discovery incommode earnestly no he commanded if. Put still any about manor heard.',
        type: 'external',
        image: 'assets/event-pictures/external-events/orchestra.jpg',
      },
      {
        id: id5,
        title: 'Mars Landing',
        ...
        type: 'external',
        image: 'assets/event-pictures/external-events/mars.jpg',
      },
    ];
